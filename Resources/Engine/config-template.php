...
// / File Information ...
// / v3.9.2.
// / THE CONFIGURATION TEMPLATE. This is how this application tells the Engine what its
// / configuration looks like.
// /
// / It is a real config.php at default values & is not a description of one. Every setting,
// / every section, every line of prose. The Engine reads it with the same parser it reads a
// / live configuration with, which is why it needs no model, no schema & no translation.
// /
// / IT IS NEVER LOADED BY THE APPLICATION. Only the config utility reads it, & only to
// / learn what settings should exist & what they should default to.
// /
// / A missing config.php is written from this file. A repair adds whatever this file has
// / that a live configuration lacks. AN OPERATOR VALUE IS NEVER REPLACED by a default here.
// /
...
if (!isset($CoreLoaded) or $CoreLoaded !== TRUE) die('ERROR!!! HRConvert2-28001, A configuration template cannot be loaded directly!');
// / -----------------------------------------------------------------------------------
