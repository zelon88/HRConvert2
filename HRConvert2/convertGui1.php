  ...
  <body>
    ...
    <div id="main" align="center">
      <div id="overview" style="max-width:1000px; text-align:left; margin:25px;">
      	<p id="info" style="display:block;"><?php echo $siteTitle; ?> is an open-source web-app that converts files without tracking users across the net or infringing on your intellectual property.</p>
        ...
        <div id="more-info" style="display:none;">
          ...
          <p>Currently <?php echo $siteTitle; ?> supports 60+ different file formats, including documents, spreadsheets, images, media, 3d models, CAD drawings, vector files, archives, disk images, & more.</p> 
      ...
      <div id="dropzone" style="max-height:2000px; max-width:1000px; margin:25px;">
        <form action="/" class="dropzone" id="filesToUpload" name="filesToUpload" method="post" enctype="multipart/form-data">
      ...
      <div align="center">
        <form action="/?showFiles=1<?php if (isset($_GET['noGui'])) echo '&noGui=TRUE'; ?>" method="post">
          <input type="hidden" id="token1" name="Token1" value="<?php echo $Token1; ?>">
          <input type="hidden" id="token2" name="Token2" value="<?php echo $Token2; ?>">
