...
// / 'Language'
$GuiSelectorText1 = 'ভাষা';
// / 'Color'
$GuiSelectorText2 = 'রঙ';
// / 'Interface'
$GuiSelectorText3 = 'ইন্টারফেস';
// / 'Display language, color and interface options'
$GuiSelectorText4 = 'ভাষা, রঙ ও ইন্টারফেস বিকল্প দেখান';
// / -----------------------------------------------------------------------------------
...
// / 'OpenSCAD Formats'
$Gui1Text32 = 'OpenSCAD ফরম্যাট';
// / 'Renders OpenSCAD source into 3D model formats.'
$Gui1Text33 = 'OpenSCAD সোর্স কোডকে ত্রিমাত্রিক মডেল ফরম্যাটে রূপান্তর করে।';
// / 'File references inside uploaded sources are removed unless the server allows resolving them.'
$Gui1Text34 = 'সার্ভার অনুমতি না দিলে আপলোড করা সোর্স ফাইলের ভিতরের ফাইল রেফারেন্স মুছে ফেলা হয়।';
...
$Gui1Text35 = 'সব আপলোড করা ফাইল মুছে নতুন সেশন শুরু করবেন?';
// / 'Start Over'
// / Labels the control that opens the panel & the button inside it that confirms.
$Gui1Text36 = 'আবার শুরু করুন';
// / 'Refresh'
...
$Gui2Text77 = 'এই উপস্থাপনাটি রূপান্তর করুন';
// / 'Convert This XPS File'
$Gui2Text78 = 'এই ফাইলটি রূপান্তর করুন';
// / 'Render This OpenSCAD Model'
$Gui2Text79 = 'এই OpenSCAD মডেলটি রেন্ডার করুন';
// / 'Render Model'
$Gui2Text80 = 'মডেল রেন্ডার করুন';
// / 'Convert This E-Book'
$Gui2Text81 = 'এই ই-বুক রূপান্তর করুন';
// / 'Convert E-Book'
$Gui2Text82 = 'ই-বুক রূপান্তর করুন';
// / 'Playlist source URL, only needed if the playlist uses relative paths'
$Gui2Text83 = 'প্লেলিস্টের উৎস URL, কেবল আপেক্ষিক পাথ ব্যবহার করলে প্রয়োজন';
// / 'Download A File From A URL'
$Gui2Text84 = 'URL থেকে ফাইল ডাউনলোড করুন';
// / 'Fetch'
$Gui2Text85 = 'আনুন';
// / -----------------------------------------------------------------------------------
