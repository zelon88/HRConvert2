    ...
    <div id="main" align="center">
      <div id="overview" style="max-width:1000px; text-align:left; margin:25px;">
        ...
        <div id="more-info" style="display:none;">
          ...
          <p><?php echo $ApplicationName; ?> unterstützt 79 verschiedene Dateiformate, darunter Dokumente, Tabellenkalkulationen, Bilder, Medien, dreidimensionale Modelle, technische Zeichnungen, Vektordateien, Archive, Disk-Images und mehr.</p> 
          ...
          <div id="supported-formats" class="supported-formats" style="margin-left:33%; display:none;">
            ...
            <p><i>Unterstützt bestimmte Bitrate.</i></p>
            <ol>
              <li>Mp2</li>
              <li>Mp3</li>
              <li>Avi</li>
            ...
            <p><i>Kann zwischen Archivformaten und Disk-Image-Formaten konvertieren.</i></p>
            <ol>
              <li>Zip</li>
              <li>Rar</li>
              <li>Tar</li>
            ...
            <p><i>Kann Bilder von Dokumenten in Dokumentformate konvertieren.</i></p>
            <p><i>Unterstützt die Größenänderung und Drehung.</i></p>
            <ol>
              <li>Jpg</li>
              <li>Jpeg</li>
              <li>Png</li>
            ...
            <p><i>Kann Zeichnungsdateien in Bildformate konvertieren.</i></p>
            <ol>
              <li>Svg</li>
              <li>Dxf</li>
              <li>Fig</li>
