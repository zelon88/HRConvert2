...
// / 'Language'
$GuiSelectorText1 = 'भाषा';
// / 'Color'
$GuiSelectorText2 = 'रंग';
// / 'Interface'
$GuiSelectorText3 = 'इंटरफ़ेस';
// / 'Display language, color and interface options'
$GuiSelectorText4 = 'भाषा, रंग और इंटरफ़ेस विकल्प दिखाएँ';
// / -----------------------------------------------------------------------------------
...
$Gui1Text35 = 'सभी अपलोड की गई फ़ाइलें हटाकर नया सत्र शुरू करें?';
// / 'Start Over'
// / Labels the control that opens the panel & the button inside it that confirms.
$Gui1Text36 = 'फिर से शुरू करें';
// / 'Refresh'
...
// / 'Convert This E-Book'
$Gui2Text81 = 'इस ई-बुक को परिवर्तित करें';
// / 'Convert E-Book'
$Gui2Text82 = 'ई-बुक परिवर्तित करें';
// / 'Playlist source URL, only needed if the playlist uses relative paths'
$Gui2Text83 = 'प्लेलिस्ट का स्रोत URL, केवल तभी आवश्यक जब प्लेलिस्ट सापेक्ष पथ का उपयोग करती हो';
// / 'Download A File From A URL'
$Gui2Text84 = 'URL से फ़ाइल डाउनलोड करें';
// / 'Fetch'
$Gui2Text85 = 'लाएँ';
// / -----------------------------------------------------------------------------------
...
$GuiFunctionsText1 = 'आपका ब्राउज़र क्लिपबोर्ड पर कॉपी करने का समर्थन नहीं करता।';
// / -----------------------------------------------------------------------------------
