  ...
  <body>
    ...
    <div id='main' align='center'>
      <div id='overview' style='max-width:1000px; text-align:<?php echo $GUIAlignment; ?>; margin:25px;'><?php echo $Gui1Text2; ?>
        ...
        <button id='userConfigButton' name='userConfigButton' class='info-button' onclick='toggle_visibility("uiSelector");' style='text-align:center; display:block; margin-left:auto; margin-right:auto;'>&#9965;</button>
        <div id='uiSelector' name='uiSelector' style='display:none; margin-left:auto; margin-right:auto; text-align:center;'>
