...
// / 'Language'
$GuiSelectorText1 = 'Lugha';
// / 'Color'
$GuiSelectorText2 = 'Rangi';
// / 'Interface'
$GuiSelectorText3 = 'Kiolesura';
// / 'Display language, color and interface options'
$GuiSelectorText4 = 'Onyesha chaguo za lugha, rangi na kiolesura';
// / -----------------------------------------------------------------------------------
...
$Gui1Text35 = 'Futa faili zote zilizopakiwa na uanze kipindi kipya?';
// / 'Start Over'
// / Labels the control that opens the panel & the button inside it that confirms.
$Gui1Text36 = 'Anza Upya';
// / 'Refresh'
