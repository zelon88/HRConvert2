<?php
// / -----------------------------------------------------------------------------------
// / THIS IS THE CONFIGURATION TEMPLATE, & everything below is a real config.php at default
// / values. Not a description of one.
// / The Engine reads it to learn what settings should exist & what they should default to.
...
// / Adding a setting to this application means adding it HERE. Nothing else needs editing.
// / Everything below the COPY FROM HERE marker is copied verbatim, including the header &
// / the guard, because a generated configuration needs both. This note is not copied,
// / because a generated configuration is not a template & should not claim to be.
// / -----------------------------------------------------------------------------------
...
// /  --Use Patched Document Engine--
// /   Whether document conversion uses the unoconv bundled with this application or the
// /   one the host has installed.
// /   The bundled copy carries patches this application depends on. The host copy is
// /   whatever the distribution shipped & is frequently older.
// /   TRUE uses Resources/Unoconv/unoconv. FALSE uses /usr/bin/unoconv.
// /   Set FALSE only if the bundled copy will not run on this host, & expect document
// /   conversion to behave differently if you do.
// /   Default is TRUE.
