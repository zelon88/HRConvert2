...
// / selects. Matched case insensitively, so clamav & ClamAV are the same scanner.
$PipelineFamily = 'ClamAV';

$PipelineDisplayName = 'ClamAV';
...
$PipelineEntryPoint = 'scanWithClamAV';
